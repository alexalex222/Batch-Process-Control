...
*loop (T,
    x.lo(T, '5') = input_const(T, '1');
    x.up(T, '5') = input_const(T, '5');

    x.lo(T, '6') = input_const(T, '2');
    x.up(T, '6') = input_const(T, '6');

    x.lo(T, '7') = input_const(T, '3');
    x.up(T, '7') = input_const(T, '7');

    x.lo(T, '8') = input_const(T, '4');
    x.up(T, '8') = input_const(T, '8');
*);
...
Objective .. JMPC =e= sum(Q, (quality(Q) - qual_set(Q))*(quality(Q) - qual_set(Q)))

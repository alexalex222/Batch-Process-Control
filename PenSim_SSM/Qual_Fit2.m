...
u_fit=zeros(size(bdb.data.u,1),size(bdb.data.u,2),nb_fit);
q_fit = zeros(size(bdb.data.q,1),size(bdb.data.q,2),nb_fit);
initialcond_fit = zeros(nb_fit,size(bdb.data.x,1));

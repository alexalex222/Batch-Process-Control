...
input_lower2(T) $(ord(T)>1) .. x(T, '8') =g= input_const('2', '1');

input_upper2(T) $(ord(T)>1) .. x(T, '8') =l= input_const('2', '2');

input_lower3(T) $(ord(T)>1) .. x(T, '9') =g= input_const('3', '1');

input_upper3(T) $(ord(T)>1) .. x(T, '9') =l= input_const('3', '2');

input_lower4(T) $(ord(T)>1) .. x(T, '10') =g= input_const('4', '1');

input_upper4(T) $(ord(T)>1) .. x(T, '10') =l= input_const('4', '2');
